...
import { CodeWriter } from "../Parser/CodeWriter.js"
...
class RustFnBodyWriter extends ASTBase {
    produceBody (indent = 4, insertReturn = true) {
...
export class MacroInvocationWriter extends Grammar.MacroInvocation {
    produceStringInterpolation (o) {
        const template = this.macroWords[1].slice(1, -1) // Remove quotes
        const allParams = this.macroWords.slice(3, -1).join("") // remove macro!("template", and closing parenthesis
...
export class AssemblyScriptProducer {
    static produce (root, outFilename) {
...
// # sourceMappingURL=AssemblyScriptProducer.js.map

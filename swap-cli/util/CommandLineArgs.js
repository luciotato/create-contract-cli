 ...
 */
    ...
    convertAmount (value, requiredUnits) {
        ...
        if (value.length > 1 && value.endsWith("N")) { // NEARS
            ...
            if (parts.length > 2) {
                color.logErr("invalid amount format, too many decimal points: " + value)
                process.exit(1)
            }
            ...
            if (value.includes(".")) {
                color.logErr("invalid amount format, YOCTOS can't have decimals: " + value)
                process.exit(1)
            }
            ...
            color.logErr("invalid amount format, expecting [0-9.](Y|N). Received: " + value)

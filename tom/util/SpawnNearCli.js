...
exports.spawnNearCli = exports.setDebug = void 0;
...
function spawnNearCli(args) {
    ...
    var execResult = child_process.spawnSync("near", args, { env: env });
    ...
    if (execResult.stdout) {
        ...
        let largeNumbers = execResult.stdout.toString().match(/\d+/g).filter((value) => value.length >= 20);
        //deduplicate
